...
{
    [CLSCompliant(false)]
    public class MonoGameAndroidFormsGameView : SurfaceView, ISurfaceHolderCallback, View.IOnTouchListener
    {
        ...
        private readonly AndroidFormsGameWindow _gameWindow;
        ...
        public MonoGameAndroidFormsGameView(Context context, AndroidFormsGameWindow gameWindow, Game game)
            : base(context)
        {
        ...
        public class BackgroundContext
        {
            ...
            MonoGameAndroidFormsGameView view;
            EGLSurface surface;

            public BackgroundContext(MonoGameAndroidFormsGameView view)
            {
                this.view = view;
                foreach (var v in MonoGame.OpenGL.GLESVersion.GetSupportedGLESVersions())
                {
