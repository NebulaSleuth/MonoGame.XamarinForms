...
{
    [CLSCompliant(false)]
    public class AndroidFormsGameWindow : GameWindow, IDisposable
    {
        internal MonoGameAndroidFormsGameView GameView { get; private set; }
        ...
        public AndroidFormsGameWindow(Android.App.Activity activity, Game game)
        {
            _game = game;
        ...
        private void Initialize(Context context, Point size)
        {
            ...
            GameView = new MonoGameAndroidFormsGameView(context, this, _game);
        ...
        private void OnRenderFrame(object sender, MonoGameAndroidFormsGameView.FrameEventArgs frameEventArgs)
        {
        ...
        private void OnUpdateFrame(object sender, MonoGameAndroidFormsGameView.FrameEventArgs frameEventArgs)
        {
            GameView.MakeCurrent();
