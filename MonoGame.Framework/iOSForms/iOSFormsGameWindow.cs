...
namespace Microsoft.Xna.Framework {
	class iOSFormsGameWindow : GameWindow {
		private readonly iOSFormsGameViewController _viewController;

		public iOSFormsGameWindow (iOSFormsGameViewController viewController)
		{
		...
		public override Rectangle ClientBounds {
			get {
                ...
                if (_viewController is iOSFormsGameViewController)
                {
