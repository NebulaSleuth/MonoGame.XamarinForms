...
{
	[CLSCompliant(false)]
    public class AndroidFormsGameActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        ...
        protected override void OnResume()
        {
            ...
            if (Game != null)
            {
                ...
                ((AndroidFormsGameWindow)Game.Window).GameView.RequestFocus();
                if (_orientationListener.CanDetectOrientation())
