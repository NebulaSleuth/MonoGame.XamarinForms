...
namespace Example1.WPF
{
    ...
    public class D3D11Host : Image
    {
        ...
        private static GraphicsDeviceManager _gfxManager;
        ...
        #region Methods
        public void SetGame(FormsGame game)
        {
            _game = game;
        }
        ...
        //{
        //    _game = Activator.CreateInstance(_gameType) as FormsGame;
        //    _game.Services.AddService(typeof(GraphicsDeviceManager), new GraphicsDeviceManager(_game, _graphicsDevice));
        //}
        private void OnLoaded(object sender, RoutedEventArgs eventArgs)
        {
            ...
            InitializeGraphicsDevice(_game);
            lock (_graphicsDeviceLock)
            {
                _game.InitDevice(_gfxManager);
            }
        ...
        private static void InitializeGraphicsDevice(FormsGame game)
        {
            lock (_graphicsDeviceLock)
            {
                _referenceCount++;
