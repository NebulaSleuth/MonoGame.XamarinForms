...
namespace Microsoft.Xna.Framework {
	...
	partial class iOSFormsGameView : UIView {
		private readonly iOSFormsGamePlatform _platform;
		private int _colorbuffer;
		private int _depthbuffer;
		private int _framebuffer;

		#region Construction/Destruction
		public iOSFormsGameView (iOSFormsGamePlatform platform, CGRect frame)
			: base(frame)
		{
			if (platform == null)
        ...
        private void CreateFramebuffer ()
		{
			...
			if (gds != null && gds.GraphicsDevice != null)
			{
                ...
                if (this.NextResponder is iOSFormsGameViewController)
                {
